...
1. **Connect your identity provider.** Studio → Registry → Connectors → add the provider
   you run (**Google Workspace**, **Okta**, **Microsoft Entra**, **AWS**, **GCP**, or
   **Copilot Studio**). Provider-side setup (app registration, IAM, scopes) is documented
   under [`docs/connectors/`](../../docs/connectors/).
   <!-- screenshot: Studio → Registry → Connectors → Add -->
