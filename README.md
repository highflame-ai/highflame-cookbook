...
| [**Agent identity**](recipes/agent-identity/) | Giving a Strands agent on Bedrock its own identity, authorization, guardrails and telemetry, then delegating to specialists | Jupyter notebook | ✅ ready |
