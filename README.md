...
> run-it-yourself companion. Registry connector setup for Entra, Copilot Studio,
> Okta, Google Workspace, Google Agent Engine, and AWS Bedrock lives in
...
| **Registry connectors** (Entra, Copilot Studio, Okta, Google Workspace, Agent Engine, AWS Bedrock) | [`recipes/connectors/`](recipes/connectors/) | Configure the provider-side app / IAM / token Highflame needs | Wire Studio discovery so agents show up ready to adopt |
...
| [**Agent governance**](recipes/agent-governance/) | Discovering, adopting & guarding agents from Google Workspace / Okta / Entra / Copilot Studio | Python script | ✅ ready |
