...
> Workspace, and Google Agent Engine lives in
...
| **Claude Code or Codex CLI** and want them to talk to Highflame directly | [`recipes/ai-gateway/`](recipes/ai-gateway/) | Point the agent's base URL at the Highflame AI Gateway | Every model call goes through Highflame — logging, policy, and routing — without changing how you use the CLI |
...
| [**AI Gateway**](recipes/ai-gateway/) | Point Claude Code or Codex at the Highflame AI Gateway | Reference docs | ✅ ready |
...
| [**Registry connectors**](recipes/connectors/) | Provider setup for Entra, Okta, Google Workspace, Google Agent Engine | Reference docs | ✅ ready |
